...
void MainWindow::setQtTestDemoBtns(QWidget *w) {
    auto demoFlowLayout = new QtmWidget::FlowLayout(w, 4, 4, 4);
...
void MainWindow::dialogShow() {
    Dialog dialog;
    auto mask = new QtmFilter::MaskWindow(&dialog, this);
...
void MainWindow::titleBarTestShow() {
    if (!m_pTitlebarTestWidget) {
