...
LabelTestWidget::LabelTestWidget(QWidget *parent) :
   ...
   QFont iconFont = QtmCore::Font::getIconFont(":/font/QtMaterialIconFont.ttf");
    ...
    m_pLab1 = new QtmWidget::VectorLabel(this);
    ...
    m_pLab2 = new QtmWidget::VectorLabel(this);
    ...
    m_pLab3 = new QtmWidget::VectorLabel(this);
    ...
    m_pLab4 = new QtmWidget::VectorLabel(this);
    ...
    m_pLab5 = new QtmWidget::VectorLabel(this);
    ...
    m_pLab6 = new QtmWidget::VectorLabel(this);
    ...
    //
    m_pCarouselLabel1 = new QtmWidget::CarouselLabel(this);
    ...
    m_pCarouselLabel2 = new QtmWidget::CarouselLabel(this);
    ...
    m_pCarouselLabel3 = new QtmWidget::CarouselLabel(this);
    ...
    m_pCarouselLabel4 = new QtmWidget::CarouselLabel(this);
    ...
    m_pDiscountLabel = new QtmWidget::DiscountLabel(this);
