...
ButtonTestWidget::ButtonTestWidget(QWidget *parent) :
    ...
    m_pBtn2->setFont(FontHelper::currentIconFont());
    ...
    m_pBtn3->setFont(FontHelper::currentIconFont());
    ...
    m_pBtn4->setFont(FontHelper::currentIconFont());
    ...
    m_pBtn5->setFont(FontHelper::currentIconFont());
    ...
    m_pBtn6->setFont(FontHelper::currentIconFont());
