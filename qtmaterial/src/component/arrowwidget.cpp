#include "component/arrowwidget.h"
#include <QHBoxLayout>
#include <QPainter>
...
void ArrowWidget::setShadowWidth(int width) {
    m_shadowWidth = width;
}

void ArrowWidget::setBorderRadius(int radius) {
    m_borderRadius = radius;
}

void ArrowWidget::setTriangleDirection(int direction) {
    m_triangleDirection = direction;
}

void ArrowWidget::setTriangleX(int x) {
    m_triangleX = x;
}

void ArrowWidget::setTriangleY(int y) {
    m_triangleY = y;
}
