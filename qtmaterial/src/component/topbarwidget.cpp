...
QWidget *TopbarWidget::contentWidget() {
    return m_contentWidget;
}

void TopbarWidget::setNormalVisible(bool visible) {
#ifdef Q_OS_MAC
#else
...
void TopbarWidget::setCloseBtnTopRight10Radius() {
    m_closeBtn->setObjectName("TopbarWidget_m_closeBtn_10Radius");
    m_closeBtn->setStyle(m_closeBtn->style());
}

void TopbarWidget::setMinVisible(bool visible) {
    m_minBtn->setVisible(visible);
    m_minMacBtn->setVisible(visible);
}

void TopbarWidget::setMaxVisible(bool visible) {
    m_maxBtn->setVisible(visible);
    m_maxMacBtn->setVisible(visible);
}
void TopbarWidget::setCloseVisible(bool visible) {
    m_closeBtn->setVisible(visible);
    m_closeMacBtn->setVisible(visible);
}

void TopbarWidget::createUi() {
    setFixedHeight(40); // 36

    m_minMacBtn = new QPushButton(this);
    m_minMacBtn->setObjectName("TopbarWidget_m_minMacBtn");
    m_minMacBtn->setFixedSize(40, 40);
    m_maxMacBtn = new QPushButton(this);
    m_maxMacBtn->setObjectName("TopbarWidget_m_maxMacBtn");
    m_maxMacBtn->setFixedSize(40, 40);
    m_normalMacBtn = new QPushButton(this);
    m_normalMacBtn->setObjectName("TopbarWidget_m_normalMacBtn");
    m_normalMacBtn->setFixedSize(40, 40);
    m_closeMacBtn = new QPushButton(this);
    m_closeMacBtn->setObjectName("TopbarWidget_m_closeMacBtn");
    ...
    m_minBtn->setObjectName("TopbarWidget_m_minBtn");
    m_minBtn->setFixedSize(40, 40);
    m_maxBtn = new QPushButton(this);
    m_maxBtn->setObjectName("TopbarWidget_m_maxBtn");
    m_maxBtn->setFixedSize(40, 40);
    m_normalBtn = new QPushButton(this);
    m_normalBtn->setObjectName("TopbarWidget_m_normalBtn");
    m_normalBtn->setFixedSize(40, 40);
    m_closeBtn = new QPushButton(this);
    m_closeBtn->setObjectName("TopbarWidget_m_closeBtn");
...
void TopbarWidget::sigConnect() {
    connect(m_minBtn, &QPushButton::clicked, this, &TopbarWidget::sigMin);
    connect(m_closeBtn, &QPushButton::clicked, this, &TopbarWidget::sigClose);
