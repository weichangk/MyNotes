...
file(GLOB_RECURSE MY_PROJECT_HEADER "${CMAKE_CURRENT_SOURCE_DIR}/inc/*.h" "${CMAKE_CURRENT_SOURCE_DIR}/inc/*.hpp")

# MY_PROJECT_HEADER添加排除
set(MY_PROJECT_HEADER_EXCLUSIVE )
macro(MY_ADD_PROJECT_HEADER_EXCLUSIVE_FUNC)
  foreach(arg ${ARGN})
      list(APPEND MY_PROJECT_HEADER_EXCLUSIVE ${arg})
  endforeach()
endmacro(MY_ADD_PROJECT_HEADER_EXCLUSIVE_FUNC)

# 查找项目源文件
set(MY_PROJECT_SOURCE )
if(MSVC)
    file(GLOB_RECURSE MY_PROJECT_SOURCE "${CMAKE_CURRENT_SOURCE_DIR}/src/*.cpp" "${CMAKE_CURRENT_SOURCE_DIR}/src/*.cc")
else()
...
# MY_PROJECT_SOURCE添加排除
set(MY_PROJECT_SOURCE_EXCLUSIVE )
macro(MY_ADD_PROJECT_SOURCE_EXCLUSIVE_FUNC)
  foreach(arg ${ARGN})
      list(APPEND MY_PROJECT_SOURCE_EXCLUSIVE ${arg})
  endforeach()
...
# 查找 Qt ui文件
set(MY_PROJECT_UI )
file(GLOB_RECURSE MY_PROJECT_UI "${CMAKE_CURRENT_SOURCE_DIR}/ui/*.ui")

# 查找 Qt ts文件
set(MY_PROJECT_TS )
file(GLOB_RECURSE MY_PROJECT_TS "${CMAKE_CURRENT_SOURCE_DIR}/lang/*.ts")

# 查找 Qt 资源文件
set(MY_PROJECT_QRC )
file(GLOB_RECURSE MY_PROJECT_QRC "${CMAKE_CURRENT_SOURCE_DIR}/qrc/*.qrc")
...
# MY_PROJECT_INCLUDE添加排除
set(MY_PROJECT_INCLUDE_EXCLUSIVE )
macro(MY_ADD_PROJECT_INCLUDE_EXCLUSIVE_FUNC)
  foreach(arg ${ARGN})
      list(APPEND MY_PROJECT_INCLUDE_EXCLUSIVE ${arg})
  endforeach()
endmacro(MY_ADD_PROJECT_INCLUDE_EXCLUSIVE_FUNC)
...
# MY_PROJECT_SOURCE_EXT添加排除
set(MY_PROJECT_SOURCE_EXT_EXCLUSIVE )
macro(MY_ADD_PROJECT_SOURCE_EXT_EXCLUSIVE_FILE_FUNC)
    file(GLOB_RECURSE  MY_PROJECT_SOURCE_EXT_EXCLUSIVE_TEMP ${ARGN})
    list(APPEND MY_PROJECT_SOURCE_EXT_EXCLUSIVE ${MY_PROJECT_SOURCE_EXT_EXCLUSIVE_TEMP})
endmacro(MY_ADD_PROJECT_SOURCE_EXT_EXCLUSIVE_FILE_FUNC)
...
# MY_PROJECT_LINKDIR添加排除
macro(MY_ADD_LINK_DIR_EXCLUSIVE_FUNC)
  foreach(arg ${ARGN})
      list(APPEND MY_PROJECT_LINKDIR_EXCLUSIVE ${arg})
  endforeach()
endmacro(MY_ADD_LINK_DIR_EXCLUSIVE_FUNC)
...
# MY_PROJECT_LINKLIB添加排除
macro(MY_ADD_LINK_LIB_EXCLUSIVE_FUNC)
  foreach(arg ${ARGN})
      list(APPEND MY_PROJECT_LINKLIB_EXCLUSIVE ${arg})
  endforeach()
endmacro(MY_ADD_LINK_LIB_EXCLUSIVE_FUNC)